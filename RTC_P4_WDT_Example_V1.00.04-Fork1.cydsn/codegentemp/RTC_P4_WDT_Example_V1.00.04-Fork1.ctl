-- ======================================================================
-- RTC_P4_WDT_Example_V1.00.04-Fork1.ctl generated from RTC_P4_WDT_Example_V1.00.04-Fork1
-- 10/27/2020 at 11:19
...
-- === RGB LED ===
attribute port_location of LED_WdtIsr(0) : label is "PORT(0,6)"; -- RED LED
attribute port_location of REPLACE_WITH_ACTUAL_PIN_NAME(0) : label is "PORT(2,6)"; -- GREEN LED
attribute port_location of LED_Alarm(0) : label is "PORT(6,5)"; -- BLUE LED

--=== LFCLK ===
attribute port_location of LFCLK_Out(0) : label is "PORT(1,4)";
